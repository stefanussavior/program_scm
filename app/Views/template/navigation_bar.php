        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseMasterData" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/master_bin">Master BIN</a>
                        <a class="collapse-item" href="/master_supplier">Master Data Supplier</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Form-Form Incoming:</h6>
                        <a class="collapse-item" href="/form_upload_data">Form Upload Data</a>
                        <!-- <a class="collapse-item" href="/form_schedule_incoming">Form Schedule Incoming</a> -->
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities"
                    ...
                    <span>BIN Services</span>
                </a>
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Custom Utilities:</h6>
                        <!-- <a class="collapse-item" href="/bin_location">BIN Location</a> -->
                        <a class="collapse-item" href="/display_data_bin_view">Display BIN View</a>
                    </div>
                </div>
            </li>
