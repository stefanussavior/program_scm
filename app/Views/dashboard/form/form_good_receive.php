            ...
            if (x < max_fields) {
                ...
                <div class="row mb-2">
                    <div class="col-sm-3">
                        ...
                        <select class="form-control kode_append" name="kode[]"></select>
                    </div>
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="text" class="form-control" name="kode_batch[]" readonly>
                    </div>
                    <div class="col-sm-3">
                    ...
                    <div class="col-sm-3">
                        ...
                        <input type="number" class="form-control" name="qty_dtg[]" readonly>
                    </div>
                    <div class="col-sm-3">
                        <label>Expired Date Barang ${x} : </label>
                        <input type="text" class="form-control" name="exp_date[]" readonly>
                    </div>
                    <div class="col-sm-3">
